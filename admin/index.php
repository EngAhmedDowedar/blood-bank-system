                        ...
                        <div class="main-content-inner">
                            <div class="main-content-wrap">
                                <div class="tf-section-2 mb-30">
                                            ...
                                            <div class="wg-chart-default mb-20">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        <div class="image ic-bg"><i class="icon-heart"></i></div>
                                                        <div>
                                                            <div class="body-text mb-2">إجمالي المتبرعين</div>
                                                            <h4>150</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="wg-chart-default mb-20">
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap14">
                                                        <div class="image ic-bg"><i class="icon-heart"></i></div>
                                                        <div>
                                                            <div class="body-text mb-2">التبرعات الناجحة</div>
                                                            <h4>100</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="wg-box">
                                        <div class="flex items-center justify-between">
                                            <h5>التبرعات المجانية</h5>
                                            <div class="dropdown default">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="icon-more"><i class="icon-more-horizontal"></i></span>
                                                </button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="javascript:void(0);">هذا الأسبوع</a></li>
                                                    <li><a href="javascript:void(0);">الأسبوع الماضي</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div>
                                                <div class="mb-2">
                                                    <div class="block-legend">
                                                        ...
                                                        <div class="text-tiny">عدد المتبرعين</div>
                                                    </div>
                                                </div>
                                                <div class="flex items-center gap10">
                                                    ...
                                                    <div class="box-icon-trending up">
                                                        ...
                                                        <div class="body-title number">5.00%</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="mb-2">
                                                    <div class="block-legend">
                                                        ...
                                                        <div class="text-tiny">عدد الوحدات المجمعة</div>
                                                    </div>
                                                </div>
                                                <div class="flex items-center gap10">
                                                    <h4>80</h4>
                                                    <div class="box-icon-trending down">
                                                        ...
                                                        <div class="body-title number">1.50%</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tf-section mb-30">
                                    <div class="wg-box">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="dropdown default">
                                                <a class="btn btn-secondary dropdown-toggle" href="#"><span class="view-all">عرض الكل</span></a>
                                            </div>
                                        </div>
