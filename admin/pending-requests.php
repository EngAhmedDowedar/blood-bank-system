...
try {
    // إزالة استخدام $userCollegeId حيث سنعرض بيانات كل الكليات
    $sql = "SELECT students.*, colleges.name 
            FROM students 
            JOIN colleges ON students.college_id = colleges.id 
            WHERE students.status = 2"; // نعرض الطلاب الذين حالتهم 2 فقط
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="list-icon-function">
                                                                        ...
                                                                        <form action="accept_student.php" method="POST" style="display:inline;">
                                                                            ...
                                                                            <button type="submit" class="item text-success accept" style="border:none; background:none;">
                                                                        ...
                                                                        <form action="reject_student.php" method="POST" style="display:inline;">
                                                                            <input type="hidden" name="id" value="<?= htmlspecialchars($student['id']); ?>">
                                                                            <button type="submit" class="item text-danger reject" style="border:none; background:none;">
